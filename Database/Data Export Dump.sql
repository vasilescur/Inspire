...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2017-06-21 23:25:43',NULL),('diagnostics.include_raw','OFF','2017-06-21 23:25:43',NULL),('ps_thread_trx_info.max_length','65535','2017-06-21 23:25:43',NULL),('statement_performance_analyzer.limit','100','2017-06-21 23:25:43',NULL),('statement_performance_analyzer.view',NULL,'2017-06-21 23:25:43',NULL),('statement_truncate_len','64','2017-06-21 23:25:43',NULL);
...
--
-- Current Database: `eripsni`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `eripsni` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `ideas` VALUES ('Brendan Li','Like Facebook but Better','My idea is to create a social networking application that allows the user to do this new thing that I just thought of, where they use a new feature to execute this action. With this app, people will be able to do this cool new thing...','Projects'),('Radu Vasilescu','Book idea','Write a book about a main character that travels to this place and talks to this person. When they get there, they should have this thing happen to them, and DIE...','Media'),('Brendan Li','Movie Idea about a Cat','This cat goes on an adventure in an abandoned warehouse and gets attacked by twelve savage dogs who are sick and going crazy and have no owners and have no civilized manners...','Media'),('ShaTia Payne','Fun thing to do with friends!','Eat out at Chuck-e-Cheese with a group of your friends for a really fun time.','Activities'),('Radu Vasilescu','Go hiking','This can be a fun idea to do with your friends: Go hiking in the countryside. Find a nice long path and walk down it for a few miles one day','Activities'),('Brendan Li','Improv - Group exercise','One idea for a neat group improv exercise could be the activity in which one person names an object, and the rest of the groups have to use their team members to form that object. Get it? Its such a fun idea...','Activities'),('Rebecca','PepTalk App','Turn PepTalk into a mobile app!','Projects'),('Radu Vasilescu','Cool new app!','Make an app that uses this cool new feature!','Projects'),('Emily','Um','A VR Headset with minigames ...','Projects');
...
-- Dump completed on 2017-06-24 17:05:46
